...
изначально был написан бэкенд без привязки к боту
поэтому сейчас 2 файла: один со всем функциями для работы с БД,
 другой с функциями работы с БД через телеграм-бот"""
